Villagecraft::Application.configure do
  ...
  config.assets.precompile += %w( a_la_carte/bootstrap-sortable.js a_la_carte/bootstrap-sortable.css a_la_carte/bootstrap-markdown.min.css a_la_carte/markdown.js a_la_carte/to-markdown.js a_la_carte/bootstrap-markdown.js a_la_carte/jquery.charactercounter.js )
  ...
  config.middleware.use ExceptionNotification::Rack,
    :email => {
      ...
      :exception_recipients => %w{ben@teitelbaum.us cheshire.in.darkness@gmail.com}
    }
end
